...
const mina = new Person('mina', 20);
const soha = new Person('soha', 60);

console.log(mina.toString());
console.log(soha.toString());
...
class Car {
  ...
  drive(distance){
    ...
    if(this.tank < gallonsNeeded){
      this.tank = 0;
      this.odometer = distancePossible + this.odometer;
